...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 16640, 16640, 16640 } // 400 steps/rev * 16 microsteps * 2.6
#define DEFAULT_MAX_FEEDRATE          { 4, 4, 4 } 
#if ENABLED(LIMITED_MAX_FR_EDITING)
                          #define MAX_FEEDRATE_EDIT_VALUES    { 4, 4, 4 } // ...or, set your own edit limits
#endif
...
#define DEFAULT_TRAVEL_ACCELERATION   20
#define HOMING_FEEDRATE_MM_M          { (4*60), (4*60), (2*60) }
...
#define Z_HOMING_HEIGHT 0     // (mm) Do not raise Z when homing XY, avoiding flexure crash 
